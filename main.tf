...
module "phase2" {
  ...
  subnet_a_pep = module.phase1.subnet_a_pep_output
  subnet_b_pep = module.phase1.subnet_b_pep_output
  eks_cluster_sg_pep = module.phase1.eks_cluster_sg_pep_output
