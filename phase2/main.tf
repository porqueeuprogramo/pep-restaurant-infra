...
locals {
  ...
  pep-restaurant-ms-manager-db-endpoint = "${module.pep-restaurant-ms-manager-db.this_db_instance_endpoint}:${module.pep-restaurant-ms-manager-db.this_db_instance_port}"
  tags = {
    Rds = "rds"
  }
}
